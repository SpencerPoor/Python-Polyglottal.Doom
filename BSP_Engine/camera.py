...
class Camera:
    ...
    # get_yaw and set_yaw allow for the acquisition of data to allow for mouse-based camera movement horizontally (on the yaw)
    def get_yaw(self):
        # Gets mouse movement data on the X axis
    ...
    def set_yaw(self):
        ...
        # Rotates Y axis by same value, allowing for simultaneous X and Y axis movement (movement of yaw)
    ...
    def update_target(self, new_target_pos: vec3):
        # Passes yaw data to the camera to change movement based on mouse input
