...
# Mathematical calulation to help determine segment partition calculations inside the BSP builder
def cross_2d(vec_0: vec2, vec_1: vec2):
    return vec_0.x * vec_1.y - vec_1.x * vec_0.y

# Determines if camera location is on the front or back side in relation to splitter
